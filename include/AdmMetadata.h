...
namespace admrender {
	...
	const std::map<std::string, std::vector<std::string>> ituPackChannels = {
	{ "AP_00010001",
		{ "M+000" }
	},
	{ "AP_00010002",
	...
	{ "AP_00010005",
		{ "M+030", "M-030", "M+000", "LFE", "M+110", "M-110", "U+030", "U-030", "U+110",
		  "U-110"
		}
	},
	{ "AP_00010010",
	...
	{ "AP_00010008",
		{ "M+030", "M-030", "M+000", "LFE", "M+090", "M-090", "M+135", "M-135", "U+045",
		  "U-045", "U+135", "U-135", "M+SC", "M-SC"
		}
	},
	{ "AP_00010009",
		{ "M+060", "M-060", "M+000", "LFEL", "M+135", "M-135", "M+030", "M-030", "M+180",
		  "LFER", "M+090", "M-090", "U+045", "U-045", "U+000", "T+000", "U+135", "U-135",
